...
public class FlipView extends FrameLayout {
	...
	public FlipView(Context context, AttributeSet attrs, int defStyle) {
		...
		mIsFlippingVertically = a.getInt(R.styleable.FlipView_flipStyle,
				VERTICAL_FLIP) == VERTICAL_FLIP;

		setOverFlipMode(OverFlipMode.values()[a.getInt(
				R.styleable.FlipView_flipMode, 0)]);
	...
	/**
	 * draw top/camera_left half shadow
	 * 
	 * @param canvas
	 */
	...
	/**
	 * draw bottom/camera_right half shadow
	 * 
	 * @param canvas
	 */
	...
	/**
	 * will draw a shade if flipping on the previous(top/camera_left) half and a shine
	 * if flipping on the next(bottom/camera_right) half
	 * 
	 * @param canvas
	 */
	...
	private float getDegreesFlipped() {
		...
		// fix for negative modulo. always want a camera_positive flip degree
