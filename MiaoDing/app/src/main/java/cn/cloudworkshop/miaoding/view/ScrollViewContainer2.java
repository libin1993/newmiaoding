 ...
 * Describe：滑动查看详情
 */
public class ScrollViewContainer2 extends RelativeLayout {
    ...
    public ScrollViewContainer2(Context context) {
        super(context);
        init();
    }

    public ScrollViewContainer2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ScrollViewContainer2(Context context, AttributeSet attrs, int defStyle) {
